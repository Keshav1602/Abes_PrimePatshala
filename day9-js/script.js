...
// 	        'x-rapidapi-key': '17b1a6ddc6mshed87f11cbdb2424p1a66f8jsn0f202f529457'
//         },
//     });
...
const showui = (list)=>{
    ...
    list.forEach((ele,idx) => {
        ...
        newCard.innerHTML = `
            <img src="${ele.videoThumbnails[0].url}" alt="thumbnail" class="thumbnail" style="width: 100%" onmouseover='handlehover(event,${idx})'>
            <h6>${ele.author}</h6>
            <h4>${ele.title}</h4>
        `;
...
const handlecardclick = (e)=>{
    ...
    const videoId = dummydata[idx].videoId;
    const url = `./video.html?videoId=${videoId}`;
